            ...
            <div className={cn(
                ...
                <div className="flex items-center gap-2">
                    ...
                    {(!isCollapsed || isMobile) && (
                        <span className="font-semibold text-sm text-vega-gray-700 dark:text-foreground">Admin Portal</span>
                    )}
                </div>
            </div>
...
export function AdminSidebar({ isCollapsed, onToggle, isMobileOpen, onMobileToggle }: {
    isCollapsed?: boolean;
    onToggle?: () => void;
